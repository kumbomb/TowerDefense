...
Shader "Custom/Monster"
{
	...
	SubShader
	{
		...
		TCP2_TEX2D_NO_SAMPLER(_Emission1);
		...
		Pass
		{
			...
			) : SV_Target
			{
				...
				float3 __emission = ( TCP2_TEX2D_SAMPLE(_Emission1, _BaseMap, input.pack0.xy).rgb );
...
/* TCP_DATA u config(ver:"2.9.11";unity:"6000.0.14f1";tmplt:"SG2_Template_URP";features:list["UNITY_5_4","UNITY_5_5","UNITY_5_6","UNITY_2017_1","UNITY_2018_1","UNITY_2018_2","UNITY_2018_3","UNITY_2019_1","UNITY_2019_2","UNITY_2019_3","UNITY_2019_4","UNITY_2020_1","UNITY_2021_1","SPECULAR","RIM","MATCAP_PERSPECTIVE_CORRECTION","MATCAP_SHADER_FEATURE","SPECULAR_SHADER_FEATURE","SPEC_LEGACY","SPECULAR_TOON","NO_RAMP","SILHOUETTE_STENCIL","OUTLINE_URP_FEATURE","SILHOUETTE_URP_FEATURE","EMISSION","OUTLINE","OUTLINE_BEHIND_STENCIL","PASS_SILHOUETTE","UNITY_2021_2","UNITY_2022_2","TEMPLATE_LWRP"];flags:list[];flags_extra:dict[];keywords:dict[RENDER_TYPE="Opaque",RampTextureDrawer="[TCP2Gradient]",RampTextureLabel="Ramp Texture",SHADER_TARGET="3.0",RIM_LABEL="Rim Lighting"];shaderProperties:list[sp(name:"Albedo";imps:list[imp_mp_texture(uto:True;tov:"";tov_lbl:"";gto:True;sbt:False;scr:False;scv:"";scv_lbl:"";gsc:False;roff:False;goff:False;sin_anm:False;sin_anmv:"";sin_anmv_lbl:"";gsin:False;notile:False;triplanar_local:False;def:"white";locked_uv:False;uv:0;cc:4;chan:"RGBA";mip:-1;mipprop:False;ssuv_vert:False;ssuv_obj:False;uv_type:Texcoord;uv_chan:"XZ";tpln_scale:1;uv_shaderproperty:__NULL__;uv_cmp:__NULL__;sep_sampler:__NULL__;prop:"_BaseMap";md:"";gbv:False;custom:False;refs:"";pnlock:False;guid:"406873f7-04b4-4ce9-ba94-a59da6b3a4bc";op:Add;lbl:"Albedo";gpu_inst:False;dots_inst:False;locked:False;impl_index:0)];layers:list[];unlocked:list[];layer_blend:dict[];custom_blend:dict[];clones:dict[];isClone:False),sp(name:"Main Color";imps:list[imp_mp_color(def:RGBA(1, 1, 1, 1);hdr:False;cc:4;chan:"RGBA";prop:"_MainColor";md:"";gbv:False;custom:False;refs:"";pnlock:False;guid:"f7fcc044-da24-4bfd-9d3d-611c90f4c049";op:Multiply;lbl:"Main Color";gpu_inst:False;dots_inst:False;locked:False;impl_index:-1)];layers:list[];unlocked:list[];layer_blend:dict[];custom_blend:dict[];clones:dict[];isClone:False),,,sp(name:"Highlight Color";imps:list[imp_constant_float(fprc:float;fv:1;guid:"7d39bac5-8a5f-436d-8f3c-49be61c0c7b5";op:Multiply;lbl:"Highlight Color";gpu_inst:False;dots_inst:False;locked:False;impl_index:-1)];layers:list[];unlocked:list[];layer_blend:dict[];custom_blend:dict[];clones:dict[];isClone:False),sp(name:"Shadow Color";imps:list[imp_constant_float(fprc:float;fv:1;guid:"1730c03d-6382-4166-9a93-807c9b327e43";op:Multiply;lbl:"Shadow Color";gpu_inst:False;dots_inst:False;locked:False;impl_index:-1)];layers:list[];unlocked:list[];layer_blend:dict[];custom_blend:dict[];clones:dict[];isClone:False),,,,,,,,,sp(name:"Emission";imps:list[imp_mp_texture(uto:False;tov:"";tov_lbl:"";gto:False;sbt:False;scr:False;scv:"";scv_lbl:"";gsc:False;roff:False;goff:False;sin_anm:False;sin_anmv:"";sin_anmv_lbl:"";gsin:False;notile:False;triplanar_local:False;def:"black";locked_uv:False;uv:0;cc:3;chan:"RGB";mip:-1;mipprop:False;ssuv_vert:False;ssuv_obj:False;uv_type:Texcoord;uv_chan:"XZ";tpln_scale:1;uv_shaderproperty:__NULL__;uv_cmp:__NULL__;sep_sampler:"_BaseMap";prop:"_Emission1";md:"";gbv:False;custom:False;refs:"";pnlock:False;guid:"dc16dbb2-dd84-451f-946b-b83a0896f313";op:Multiply;lbl:"Emission Texture";gpu_inst:False;dots_inst:False;locked:False;impl_index:-1)];layers:list[];unlocked:list[];layer_blend:dict[];custom_blend:dict[];clones:dict[];isClone:False)];customTextures:list[];codeInjection:codeInjection(injectedFiles:list[];mark:False);matLayers:list[]) */
/* TCP_HASH 1f5154db5a4a0a2c647bc511bd81d633 */
