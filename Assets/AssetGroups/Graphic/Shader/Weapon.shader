...
/* TCP_DATA u config(ver:"2.9.11";unity:"6000.0.14f1";tmplt:"SG2_Template_URP";features:list["UNITY_5_4","UNITY_5_5","UNITY_5_6","UNITY_2017_1","UNITY_2018_1","UNITY_2018_2","UNITY_2018_3","UNITY_2019_1","UNITY_2019_2","UNITY_2019_3","UNITY_2019_4","UNITY_2020_1","UNITY_2021_1","RIM","MATCAP_PERSPECTIVE_CORRECTION","MATCAP_SHADER_FEATURE","SILHOUETTE_STENCIL","SILHOUETTE_URP_FEATURE","SHADOW_COLOR_MAIN_DIR","SHADOW_COLOR_LERP","ATTEN_AT_NDL","RIM_DIR","RIM_DIR_PERSP_CORRECTION","NO_RAMP_UNLIT","WRAPPED_LIGHTING_HALF","WRAPPED_LIGHTING_MAIN_LIGHT","PASS_SILHOUETTE","UNITY_2021_2","UNITY_2022_2","TEMPLATE_LWRP"];flags:list[];flags_extra:dict[];keywords:dict[RENDER_TYPE="Opaque",RampTextureDrawer="[TCP2Gradient]",RampTextureLabel="Ramp Texture",SHADER_TARGET="3.0",RIM_LABEL="Rim Lighting"];shaderProperties:list[,,,,sp(name:"Highlight Color";imps:list[imp_constant_float(fprc:float;fv:1;guid:"b3050c65-c00c-4075-abf2-8825ce0742cb";op:Multiply;lbl:"Highlight Color";gpu_inst:False;dots_inst:False;locked:False;impl_index:-1)];layers:list[];unlocked:list[];layer_blend:dict[];custom_blend:dict[];clones:dict[];isClone:False),sp(name:"Shadow Color";imps:list[imp_constant_float(fprc:float;fv:1;guid:"9fb7868a-90c8-431d-8007-71e15f9fbf30";op:Multiply;lbl:"Shadow Color";gpu_inst:False;dots_inst:False;locked:False;impl_index:-1)];layers:list[];unlocked:list[];layer_blend:dict[];custom_blend:dict[];clones:dict[];isClone:False)];customTextures:list[];codeInjection:codeInjection(injectedFiles:list[];mark:False);matLayers:list[]) */
/* TCP_HASH 5351cc7428fc99481db0d4568fb79b5b */
